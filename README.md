# bicc-igebc — Odoo Customizations

Instance repository for the bicc-igebc Odoo database. Managed through the [OdooAiDeployer](https://github.com/dietbald/OdooAiDeployer) deployment system.
